...
ACS800PGainInit = 0.01; % p Gain for the speed PI controller
ACS800IGainInit = 0;    % i Gain for the speed PI controller
ACS800PILimUp = 30;     % upper limit in % of torque
ACS800PILimLo = -30;     % lower limit in % of torque
