 ...
 * C++ source code generated on : Thu Jun 25 13:15:07 2026
 *
...
const int32_T windEmulatorStep4_CALL_EVENT_n = -1;
...
const int32_T windEmulatorStep4_CALL_EVENT_k = -1;
...
XDis_windEmulatorStep4_T windEmulatorStep4_XDis;
...
{
  localDW->sfEvent = windEmulatorStep4_CALL_EVENT;
}
...
{
  localDW->sfEvent = windEmulatorStep4_CALL_EVENT_n;
}
...
static void windEmulatorS_swParseStatusWord(void)
{
  ...
  windEmulatorStep4_DW.swRDY_ON_f = 0.0;
  windEmulatorStep4_DW.swRDY_RUN_f = 0.0;
  windEmulatorStep4_DW.swRDY_REF_a = 0.0;
  windEmulatorStep4_DW.swTRIPPED_e = 0.0;
  windEmulatorStep4_DW.swOFF_2_STA_c = 0.0;
  windEmulatorStep4_DW.swOFF_3_STA_i = 0.0;
  windEmulatorStep4_DW.swSWC_ON_INHIB_l = 0.0;
  windEmulatorStep4_DW.swWARNING_k = 0.0;
  windEmulatorStep4_DW.swAT_SETPOINT_b = 0.0;
  windEmulatorStep4_DW.swREMOTE_j = 0.0;
  windEmulatorStep4_DW.swABOVE_LIMIT_a = 0.0;
  windEmulatorStep4_DW.swEXT_CTRL_LOC_c = 0.0;
  windEmulatorStep4_DW.swEXT_RUN_ENABLE_h = 0.0;
  windEmulatorStep4_DW.swMSW_B13_l = 0.0;
  windEmulatorStep4_DW.swMSW_B14_i = 0.0;
  windEmulatorStep4_DW.swCOMM_ERR_p = 0.0;
  if (windEmulatorStep4_B.BusAssignment_h.statusWord >= 32768) {
    uint32_T q0;
    windEmulatorStep4_DW.swCOMM_ERR_p = 1.0;
  ...
  if (sw >= 16384) {
    windEmulatorStep4_DW.swMSW_B14_i = 1.0;
    sw = static_cast<uint16_T>(sw - 16384);
  }

  if (sw >= 8192) {
    windEmulatorStep4_DW.swMSW_B13_l = 1.0;
    sw = static_cast<uint16_T>(sw - 8192);
  }

  if (sw >= 4096) {
    windEmulatorStep4_DW.swEXT_RUN_ENABLE_h = 1.0;
    sw = static_cast<uint16_T>(sw - 4096);
  }

  if (sw >= 2048) {
    windEmulatorStep4_DW.swEXT_CTRL_LOC_c = 1.0;
    sw = static_cast<uint16_T>(sw - 2048);
  }

  if (sw >= 1024) {
    windEmulatorStep4_DW.swABOVE_LIMIT_a = 1.0;
    sw = static_cast<uint16_T>(sw - 1024);
  }

  if (sw >= 512) {
    windEmulatorStep4_DW.swREMOTE_j = 1.0;
    sw = static_cast<uint16_T>(sw - 512);
  }
  ...
  if (sw >= 128) {
    windEmulatorStep4_DW.swWARNING_k = 1.0;
    sw = static_cast<uint16_T>(sw - 128);
  }

  if (sw >= 64) {
    windEmulatorStep4_DW.swSWC_ON_INHIB_l = 1.0;
    sw = static_cast<uint16_T>(sw - 64);
  }

  if (sw >= 32) {
    windEmulatorStep4_DW.swOFF_3_STA_i = 1.0;
    sw = static_cast<uint16_T>(sw - 32);
  }

  if (sw >= 16) {
    windEmulatorStep4_DW.swOFF_2_STA_c = 1.0;
    sw = static_cast<uint16_T>(sw - 16);
  }

  if (sw >= 8) {
    windEmulatorStep4_DW.swTRIPPED_e = 1.0;
    sw = static_cast<uint16_T>(sw - 8);
  }

  if (sw >= 4) {
    windEmulatorStep4_DW.swRDY_REF_a = 1.0;
    sw = static_cast<uint16_T>(sw - 4);
  }

  if (sw >= 2) {
    windEmulatorStep4_DW.swRDY_RUN_f = 1.0;
    sw = static_cast<uint16_T>(sw - 2);
  }

  if (sw >= 1) {
    windEmulatorStep4_DW.swRDY_ON_f = 1.0;
  }
}
...
static void windEmulator_cwBuildControlWord(void)
{
  windEmulatorStep4_B.ControlWord_l = 0U;
  if (windEmulatorStep4_DW.cwOFF1_CONTROL_i != 0.0) {
    windEmulatorStep4_B.ControlWord_l = 1U;
  }

  if (windEmulatorStep4_DW.cwOFF2_CONTROL_b != 0.0) {
    windEmulatorStep4_B.ControlWord_l = static_cast<uint16_T>
      (windEmulatorStep4_B.ControlWord_l | 2);
  }

  if (windEmulatorStep4_DW.cwOFF3_CONTROL_n != 0.0) {
    windEmulatorStep4_B.ControlWord_l = static_cast<uint16_T>
      (windEmulatorStep4_B.ControlWord_l | 4);
  }

  if (windEmulatorStep4_DW.cwENABLE_OPERATION_l != 0.0) {
    windEmulatorStep4_B.ControlWord_l = static_cast<uint16_T>
      (windEmulatorStep4_B.ControlWord_l | 8);
  }

  if (windEmulatorStep4_DW.cwRAMP_OUT_ZERO_m != 0.0) {
    windEmulatorStep4_B.ControlWord_l = static_cast<uint16_T>
      (windEmulatorStep4_B.ControlWord_l | 16);
  }

  if (windEmulatorStep4_DW.cwRAMP_HOLD_j != 0.0) {
    windEmulatorStep4_B.ControlWord_l = static_cast<uint16_T>
      (windEmulatorStep4_B.ControlWord_l | 32);
  }

  if (windEmulatorStep4_DW.cwRAMP_IN_ZERO_m != 0.0) {
    windEmulatorStep4_B.ControlWord_l = static_cast<uint16_T>
      (windEmulatorStep4_B.ControlWord_l | 64);
  }

  if (windEmulatorStep4_DW.cwRESET_e != 0.0) {
    windEmulatorStep4_B.ControlWord_l = static_cast<uint16_T>
      (windEmulatorStep4_B.ControlWord_l | 128);
  }

  if (windEmulatorStep4_DW.cwREMOTE_CMD_c != 0.0) {
    windEmulatorStep4_B.ControlWord_l = static_cast<uint16_T>
      (windEmulatorStep4_B.ControlWord_l | 1024);
  }

  if (windEmulatorStep4_B.ACS800CtrlMode) {
    windEmulatorStep4_B.ControlWord_l = static_cast<uint16_T>
      (windEmulatorStep4_B.ControlWord_l | 2048);
  }
}
...
static void windEmulatorStep4_cwInitialize(void)
{
  windEmulatorStep4_DW.cwOFF1_CONTROL_i = 0.0;
  windEmulatorStep4_DW.cwOFF2_CONTROL_b = 1.0;
  windEmulatorStep4_DW.cwOFF3_CONTROL_n = 1.0;
  windEmulatorStep4_DW.cwENABLE_OPERATION_l = 0.0;
  windEmulatorStep4_DW.cwRAMP_OUT_ZERO_m = 1.0;
  windEmulatorStep4_DW.cwRAMP_HOLD_j = 1.0;
  windEmulatorStep4_DW.cwRAMP_IN_ZERO_m = 1.0;
  windEmulatorStep4_DW.cwRESET_e = 0.0;
  windEmulatorStep4_DW.cwREMOTE_CMD_c = 1.0;
}
...
void windEmulatorStep4_step(void)
{
...

  {
    ...
    char *msg;
    struct_KY1U3Kyrwv5e6VnUIBWG5G *tmp_g;
    struct_KY1U3Kyrwv5e6VnUIBWG5G *tmp_h;
    struct_KY1U3Kyrwv5e6VnUIBWG5G *tmp_i;
    real_T tmp_2[57];
    real_T tmp_0[20];
    real_T tmp[3];
    real_T Clock_tmp;
    ...
    /* Gain: '<S2>/Nm -> %' */
    tmp_l = *get_acs880RatedTorque();

    /* Product: '<S125>/Product' incorporates:
     *  Constant: '<S125>/UnitsConversion'
     ...
     */
    tmp_j = *get_belowMinPGain();

    /* Gain: '<S60>/Gain1' */
    tmp_i = get_PressureControl();

    /* Gain: '<S125>/Gain1' */
    tmp_h = get_TorqueInputControl();

    /* Gain: '<S105>/Proportional Gain' */
    tmp_g = get_SpeedControl();

    /* Switch: '<S124>/Switch' incorporates:
     *  Constant: '<S124>/DeadBandController'
     *  Switch generated from: '<S53>/Switch'
     */
    tmp_f = *get_deadBandController();

    /* Chart: '<S4>/FexcRamp' */
    u1 = *get_rampTime();

    /* Switch generated from: '<S53>/Switch' */
    tmp_e = *get_minTorqueRef_Nm();

    /* RateLimiter: '<S61>/Rate Limiter' */
    tmp_d = *get_deadbandTorqueSlewRate();

    /* RateLimiter: '<S297>/speedSlewRate' */
    u2 = *get_fromFileSpeedSlewRate();

    /* RateLimiter: '<S297>/torqueSlewRate' */
...

    {
      ...
      /* SimscapeInputBlock: '<S229>/INPUT_1_1_1' incorporates:
       *  SimscapeInputBlock: '<S229>/INPUT_5_1_1'
       */
      tmp_4 = rtmIsMajorTimeStep(windEmulatorStep4_M);
      if (tmp_4) {
        ...
        /* Gain: '<S48>/rpm -> rad//s' */
        windEmulatorStep4_B.rpmrads = tmp_5 *
          windEmulatorStep4_B.BusAssignment_a.motorSpeed_rpm;
        ...
        windEmulatorSte_ParseStatusWord
          (windEmulatorStep4_B.BusAssignment_a.statusWord,
           ...
           &windEmulatorStep4_DW.sf_ParseStatusWord_h);
        ...
        /* Constant: '<S2>/ACS880CtrlMode' */
        windEmulatorStep4_B.ACS880CtrlMode = tmp_6;
        ...
        if (windEmulatorStep4_DW.temporalCounter_i1_l < 31) {
          windEmulatorStep4_DW.temporalCounter_i1_l = static_cast<uint8_T>
            (windEmulatorStep4_DW.temporalCounter_i1_l + 1);
        }

        windEmulatorStep4_DW.sfEvent_l = windEmulatorStep4_CALL_EVENT_k;
        if (windEmulatorStep4_DW.is_active_c7_windEmulatorStep4 == 0) {
          ...
          windEmulatorStep4_B.state_e = abbStateEnum_init;
          ...
          switch (windEmulatorStep4_DW.is_UpdateStateMachine) {
           case windEmulatorStep4_IN_DelayOFF1:
            if (windEmulatorStep4_DW.temporalCounter_i1_l >= 25) {
              windEmulatorStep4_DW.is_UpdateStateMachine =
                windEmula_IN_notReadyToSwitchOn;
              windEmulatorStep4_DW.cwOFF1_CONTROL = 0.0;
            } else {
              windEmulatorStep4_B.state_e = abbStateEnum_delayOff1;
            }
            break;
           ...
           case windEmula_IN_notReadyToSwitchOn:
            f = ((windEmulatorStep4_DW.swRDY_ON == 1.0) &&
                 (windEmulatorStep4_DW.swWARNING == 0.0));
            if (f) {
              windEmulatorStep4_DW.is_UpdateStateMachine =
              ...
              windEmulatorStep4_B.state_e = abbStateEnum_notReadyToSwitchOn;
            }
            break;

           case windEmulat_IN_operationDisabled:
            f = (windEmulatorStep4_B.NotEqual && (windEmulatorStep4_DW.swRDY_RUN
                  == 1.0));
            if (f) {
              windEmulatorStep4_DW.is_UpdateStateMachine =
              ...
              f = (windEmulatorStep4_B.NotEqual1 ||
                   windEmulatorStep4_B.NotEqual_i ||
                   (windEmulatorStep4_DW.swTRIPPED == 1.0) ||
                   (windEmulatorStep4_DW.swSWC_ON_INHIB == 1.0) ||
                   (windEmulatorStep4_DW.swWARNING == 1.0));
              if (f) {
                ...
                windEmulatorStep4_B.state_e = abbStateEnum_operationDisabled;
              }
            }
            break;
           ...
           case windEmulato_IN_operationEnabled:
            if (windEmulatorStep4_B.NotEqual1) {
              ...
              f = (windEmulatorStep4_B.NotEqual_i ||
                   (windEmulatorStep4_DW.swTRIPPED == 1.0) ||
                   (windEmulatorStep4_DW.swSWC_ON_INHIB == 1.0) ||
                   (windEmulatorStep4_DW.swWARNING == 1.0));
              if (f) {
                ...
                windEmulatorStep4_B.state_e = abbStateEnum_operationEnabled;
              }
            }
            break;
           ...
           default:
            ...
            f = (windEmulatorStep4_B.NotEqual && (windEmulatorStep4_DW.swREMOTE ==
                  1.0));
            if (f) {
              windEmulatorStep4_DW.is_UpdateStateMachine =
                windEmulat_IN_operationDisabled;
              ...
              windEmulatorStep4_B.state_e = abbStateEnum_readyToSwitchOn;
            }
            break;
          }
        ...
        windEmulatorStep4_B.CastToDouble1_a = windEmulatorStep4_B.state_e;
        ...
        windEmulatorStep4_DW.sfEvent = windEmulatorStep4_CALL_EVENT_k;
        if (windEmulatorStep4_DW.is_active_c3_windEmulatorStep4 == 0) {
          ...
          windEmulatorStep4_B.runCounter_b = 0U;
          windEmulatorStep4_B.stepCounter_n = 1U;
          windEmulatorStep4_B.ramp_l = 0.0;
          windEmulatorStep4_DW.rampLast = 0.0;
          windEmulatorStep4_B.time_c = 0.0;
          windEmulatorStep4_DW.rampUpTime = 0.0;
          windEmulatorStep4_DW.runTime = 0.0;
          windEmulatorStep4_B.resetHilIntegrator_h = true;
          windEmulatorStep4_B.resetSidIntegrator_h = true;
        } else {
          switch (windEmulatorStep4_DW.is_c3_windEmulatorStep4) {
           case windEmulatorStep4_IN_idle:
            if (windEmulatorStep4_B.NotEqual1_a) {
              ...
              q0 = windEmulatorStep4_B.runCounter_b;
              qY = q0 + 1U;
              if (qY < q0) {
                qY = MAX_uint32_T;
              }

              windEmulatorStep4_B.runCounter_b = qY;
              windEmulatorStep4_B.resetHilIntegrator_h =
                (windEmulatorStep4_B.expType_a != expTypeEnum_hil);
              windEmulatorStep4_B.resetSidIntegrator_h =
           ...
           case windEmulatorStep4_IN_rampdown:
            if (windEmulatorStep4_B.ramp_l <= 0.0) {
              windEmulatorStep4_DW.is_c3_windEmulatorStep4 =
                windEmulatorStep4_IN_idle;
            } else {
              ...
              windEmulatorStep4_B.ramp_l = windEmulatorStep4_DW.rampLast - u1;
              windEmulatorStep4_B.time_c = (windEmulatorStep4_DW.rampUpTime +
                windEmulatorStep4_DW.runTime) + static_cast<real_T>
                (windEmulatorStep4_DW.temporalCounter_i1) * 0.004;
              q0 = windEmulatorStep4_B.stepCounter_n;
              qY = q0 + 1U;
              if (qY < q0) {
                qY = MAX_uint32_T;
              }

              windEmulatorStep4_B.stepCounter_n = qY;
              windEmulatorStep4_B.resetHilIntegrator_h =
                (windEmulatorStep4_B.expType_a != expTypeEnum_hil);
              windEmulatorStep4_B.resetSidIntegrator_h =
                (windEmulatorStep4_B.expType_a != expTypeEnum_sid);
           ...
           case windEmulatorStep4_IN_rampup:
            if (windEmulatorStep4_B.NotEqual2_c) {
            ...
            } else if (windEmulatorStep4_B.ramp_l >= 1.0) {
              windEmulatorStep4_DW.temporalCounter_i1 = 0U;
              windEmulatorStep4_DW.is_c3_windEmulatorStep4 =
              ...
              if ((u1 >= 1.0) || rtIsNaN(u1)) {
                windEmulatorStep4_B.ramp_l = 1.0;
              } else {
                windEmulatorStep4_B.ramp_l = u1;
              }
              ...
              windEmulatorStep4_B.stepCounter_n = qY;
              windEmulatorStep4_DW.rampLast = windEmulatorStep4_B.ramp_l;
           ...
           default:
            /* case IN_runing: */
            f = (windEmulatorStep4_B.NotEqual2_c || (windEmulatorStep4_B.time_c >=
        ...
        windEmulatorStep4_B.BusAssignment_b.time = windEmulatorStep4_B.time_c;
        windEmulatorStep4_B.BusAssignment_b.ramp = windEmulatorStep4_B.ramp_l;
        windEmulatorStep4_B.BusAssignment_b.runCounter =
          windEmulatorStep4_B.runCounter_b;
        windEmulatorStep4_B.BusAssignment_b.stepCounter =
          windEmulatorStep4_B.stepCounter_n;
        ...
        /* MultiPortSwitch: '<S297>/Multiport Switch' incorporates:
         *  Constant: '<S243>/sidType'
         */
        switch (windEmulatorStep4_cal->sidType_Value) {
         ...
         case sidTypeEnum_fromFile:
          /* MultiPortSwitch: '<S297>/Multiport Switch' */
          windEmulatorStep4_B.MultiportSwitch_h =
            windEmulatorStep4_B.BusAssignment_b.stepCounter;
          break;
        ...
        /* End of MultiPortSwitch: '<S297>/Multiport Switch' */

        /* Math: '<S297>/Mod' incorporates:
         *  Constant: '<S297>/Length of input'
         */
        ...
        /* End of Math: '<S297>/Mod' */

        /* RelationalOperator: '<S297>/Out of bounds' incorporates:
         *  Constant: '<S297>/Length of input'
         */
      ...
      if (windEmulatorStep4_DW.LastMajorTime == (rtInf)) {
        ...
        deltaT_tmp = windEmulatorStep4_M->Timing.t[0];
        Clock_tmp = deltaT_tmp - windEmulatorStep4_DW.LastMajorTime;
        if (windEmulatorStep4_DW.LastMajorTime == deltaT_tmp) {
          if (windEmulatorStep4_DW.PrevLimited) {
            /* RateLimiter: '<S297>/torqueSlewRate' */
          ...
          if (rtsiIsModeUpdateTimeStep(&windEmulatorStep4_M->solverInfo)) {
            windEmulatorStep4_DW.PrevLimited = limitedCache;
          }
        }
      }
      ...
      switch (windEmulatorStep4_cal->sidType_Value) {
       ...
       case sidTypeEnum_manual:
        /* MultiPortSwitch: '<S243>/Multiport Switch' incorporates:
         *  Constant: '<S243>/manualTorqueSetpoint_Nm'
         */
        windEmulatorStep4_B.MultiportSwitch =
       ...
       case sidTypeEnum_fromFile:
        /* Gain: '<S297>/fromFileTorqueNow_Nm' */
        ...
        /* MultiPortSwitch: '<S243>/Multiport Switch' */
        windEmulatorStep4_B.MultiportSwitch =
          windEmulatorStep4_B.fromFileTorqueNow_Nm;
        break;
      ...
      /* RateLimiter: '<S297>/speedSlewRate' */
      if (windEmulatorStep4_DW.LastMajorTime_j == (rtInf)) {
        /* RateLimiter: '<S297>/speedSlewRate' */
        windEmulatorStep4_B.speedSlewRate = windEmulatorStep4_B.Switch1;
      } else {
        deltaT_tmp = windEmulatorStep4_M->Timing.t[0];
        Clock_tmp = deltaT_tmp - windEmulatorStep4_DW.LastMajorTime_j;
        if (windEmulatorStep4_DW.LastMajorTime_j == deltaT_tmp) {
          if (windEmulatorStep4_DW.PrevLimited_d) {
            /* RateLimiter: '<S297>/speedSlewRate' */
          ...
          if (rtsiIsModeUpdateTimeStep(&windEmulatorStep4_M->solverInfo)) {
            windEmulatorStep4_DW.PrevLimited_d = limitedCache;
          }
        }
      }

      /* MultiPortSwitch: '<S243>/Multiport Switch1' incorporates:
       *  Constant: '<S243>/sidType'
       */
      switch (windEmulatorStep4_cal->sidType_Value) {
       case sidTypeEnum_off:
       ...
       case sidTypeEnum_manual:
        /* MultiPortSwitch: '<S243>/Multiport Switch1' incorporates:
         *  Constant: '<S243>/manualSpeedSetpoint_rpm'
         */
        windEmulatorStep4_B.MultiportSwitch1 =
      ...
      /* End of MultiPortSwitch: '<S243>/Multiport Switch1' */
      ...
      /* Integrator: '<S278>/Integrator' incorporates:
       *  RateLimiter: '<S124>/Rate Limiter'
       *  RateLimiter: '<S2>/acs880RateLim'
       *  RateLimiter: '<S61>/Rate Limiter'
       */
      f = rtsiIsModeUpdateTimeStep(&windEmulatorStep4_M->solverInfo);
      if (f) {
        limitedCache = (((windEmulatorStep4_PrevZCX.Integrator_Reset_ZCE ==
                          POS_ZCSIG) !=
                         windEmulatorStep4_B.BusAssignment_b.resetSidIntegrator)
       ...
       *  Constant: '<S13>/Constant1'
       */
      windEmulatorStep4_B.LowerRelop1 = (windEmulatorStep4_B.Sum_k > tmp_7);

      /* RelationalOperator: '<S286>/UpperRelop' incorporates:
       *  Constant: '<S13>/Constant2'
       */
      windEmulatorStep4_B.UpperRelop = (windEmulatorStep4_B.Sum_k < tmp_8);
      ...
      if (windEmulatorStep4_B.UpperRelop) {
         ...
         *  Constant: '<S13>/Constant2'
         */
        windEmulatorStep4_B.Switch = tmp_8;
      } else {
        /* Switch: '<S286>/Switch' */
      ...
      if (windEmulatorStep4_B.LowerRelop1) {
         ...
         *  Constant: '<S13>/Constant1'
         */
        windEmulatorStep4_B.Switch2_h = tmp_7;
      } else {
        /* Switch: '<S286>/Switch2' */
      ...
      windEmulatorStep4_B.ControlSignal31 = u1 * windEmulatorStep4_B.Add;
      ...
      /* CombinatorialLogic: '<S121>/Logic' incorporates:
       *  Constant: '<S119>/Constant'
       */
      limitedCache = windEmulatorStep4_B.RelationalOperator;
      q0 = limitedCache;
      limitedCache = windEmulatorStep4_cal->Constant_Value_b;
      q0 = (q0 << 1) + limitedCache;
      limitedCache = windEmulatorStep4_B.Memory_f;
      q0 = (q0 << 1) + limitedCache;
      windEmulatorStep4_B.Logic[0U] = windEmulatorStep4_cal->Logic_table[q0];
      windEmulatorStep4_B.Logic[1U] = windEmulatorStep4_cal->Logic_table[q0 + 8U];
      ...
      windEmulatorStep4_B.ControlSignal31_o = u1 * windEmulatorStep4_B.Add1;
       ...
       */
      limitedCache = windEmulatorStep4_B.RelationalOperator_k;
      q0 = limitedCache;
      limitedCache = windEmulatorStep4_cal->Constant_Value_k;
      q0 = (q0 << 1) + limitedCache;
      limitedCache = windEmulatorStep4_B.Memory_in;
      q0 = (q0 << 1) + limitedCache;
      windEmulatorStep4_B.Logic_g[0U] = windEmulatorStep4_cal->Logic_table_o[q0];
      windEmulatorStep4_B.Logic_g[1U] = windEmulatorStep4_cal->Logic_table_o[q0
        + 8U];
      ...
      if (windEmulatorStep4_B.Add > windEmulatorStep4_cal->Switch_Threshold_j) {
        ...
        if (windEmulatorStep4_B.Logic[0]) {
          ...
          rateLimiterRate = windEmulatorStep4_B.ControlSignal31;
          u1 = windEmulatorStep4_cal->Saturation_LowerSat;
          u2 = windEmulatorStep4_cal->Saturation_UpperSat;
          if (rateLimiterRate > u2) {
            /* Saturate: '<S119>/Saturation' */
            windEmulatorStep4_B.Saturation_a3 = u2;
          } else if (rateLimiterRate < u1) {
            /* Saturate: '<S119>/Saturation' */
        ...
        if (windEmulatorStep4_B.Add1 > windEmulatorStep4_cal->Switch1_Threshold)
        {
          ...
          if (windEmulatorStep4_B.Logic_g[0]) {
             ...
             *  Switch: '<S64>/Switch1'
             */
            rateLimiterRate = windEmulatorStep4_B.ControlSignal31_o;
            u1 = windEmulatorStep4_cal->Saturation_LowerSat_n;
            u2 = windEmulatorStep4_cal->Saturation_UpperSat_g;
            if (rateLimiterRate > u2) {
              /* Saturate: '<S120>/Saturation' */
              windEmulatorStep4_B.Saturation_k = u2;
            } else if (rateLimiterRate < u1) {
              /* Saturate: '<S120>/Saturation' */
      ...
      /* Gain: '<S64>/Gain' */
      windEmulatorStep4_B.Gain_l = tmp_9 * windEmulatorStep4_B.Switch_g;
      ...
      if (windEmulatorStep4_DW.LastMajorTime_d == (rtInf)) {
        ...
        deltaT_tmp = windEmulatorStep4_M->Timing.t[0];
        Clock_tmp = deltaT_tmp - windEmulatorStep4_DW.LastMajorTime_d;
        if (windEmulatorStep4_DW.LastMajorTime_d == deltaT_tmp) {
          if (windEmulatorStep4_DW.PrevLimited_g) {
            /* RateLimiter: '<S61>/Rate Limiter' */
          ...
          if (f) {
            windEmulatorStep4_DW.PrevLimited_g = limitedCache;
          }
        }
      }
      ...
      if (tmp_4) {
        /* Gain: '<S105>/Proportional Gain' */
        windEmulatorStep4_B.ProportionalGain = tmp_g->PG *
          windEmulatorStep4_B.wError;
         ...
         *  Constant: '<S63>/Constant'
         */
        windEmulatorStep4_B.LowerRelop1_g = (windEmulatorStep4_B.Sum_c > tmp_a);
        ...
        windEmulatorStep4_B.UpperRelop_g = (windEmulatorStep4_B.Sum_c < u1);
        ...
        if (windEmulatorStep4_B.UpperRelop_g) {
           ...
           *  Constant: '<S63>/Constant1'
           */
          windEmulatorStep4_B.Switch_i = -tmp_a;
        } else {
          /* Switch: '<S108>/Switch' */
        ...
        if (windEmulatorStep4_B.LowerRelop1_g) {
           ...
           *  Constant: '<S63>/Constant'
           */
          windEmulatorStep4_B.Switch2_k = tmp_a;
        } else {
          /* Switch: '<S108>/Switch2' */
      ...
      /* Step: '<S58>/Step' incorporates:
       *  RateLimiter: '<S124>/Rate Limiter'
       *  RateLimiter: '<S2>/acs880RateLim'
       */
      deltaT_tmp = windEmulatorStep4_M->Timing.t[0];
      if (deltaT_tmp < windEmulatorStep4_cal->Ramp_start) {
        /* Step: '<S58>/Step' */
      ...
      /* Clock: '<S58>/Clock' incorporates:
       *  SimscapeExecutionBlock: '<S229>/STATE_1'
       *  SimscapeRtp: '<S196>/RTP_1'
       */
      Clock_tmp = windEmulatorStep4_M->Timing.t[0];

      /* Clock: '<S58>/Clock' */
      windEmulatorStep4_B.Clock = Clock_tmp;
      ...
      rateLimiterRate = windEmulatorStep4_B.Output;
      u1 = windEmulatorStep4_cal->Saturation_LowerSat_em;
      u2 = windEmulatorStep4_cal->Saturation_UpperSat_da;
      if (rateLimiterRate > u2) {
        /* Saturate: '<S53>/Saturation' */
        windEmulatorStep4_B.Saturation = u2;
      } else if (rateLimiterRate < u1) {
        /* Saturate: '<S53>/Saturation' */
      ...
      if (tmp_4) {
        ...
        /* RateLimiter: '<S186>/Rate Limiter' incorporates:
         *  Constant: '<S186>/Constant1'
         */
        u1 = 2000.0 * tmp_5;
        rateLimiterRate = u1 - windEmulatorStep4_DW.PrevY_k;
        if (rateLimiterRate > windEmulatorStep4_cal->RateLimiter_RisingLim_j *
            windEmulatorStep4_period) {
          /* RateLimiter: '<S186>/Rate Limiter' */
          ...
          /* RateLimiter: '<S186>/Rate Limiter' */
          windEmulatorStep4_B.RateLimiter_a = 2000.0 * tmp_5;
        }

        windEmulatorStep4_DW.PrevY_k = windEmulatorStep4_B.RateLimiter_a;

        /* End of RateLimiter: '<S186>/Rate Limiter' */

        /* SimscapeInputBlock: '<S229>/INPUT_1_1_1' */
        ...
        windEmulatorStep4_DW.INPUT_1_1_1_Discrete_142920204[0] =
          !(windEmulatorStep4_B.INPUT_1_1_1[0] ==
            windEmulatorStep4_DW.INPUT_1_1_1_Discrete_142920204[1]);
        windEmulatorStep4_DW.INPUT_1_1_1_Discrete_142920204[1] =
          windEmulatorStep4_B.INPUT_1_1_1[0];
        windEmulatorStep4_B.INPUT_1_1_1[0] =
          windEmulatorStep4_DW.INPUT_1_1_1_Discrete_142920204[1];
      ...
      /* SimscapeInputBlock: '<S229>/INPUT_2_1_1' */
      ...
      /* SimscapeInputBlock: '<S229>/INPUT_4_1_1' */
      ...
      if (tmp_4) {
        /* Gain: '<S54>/Gain' */
        windEmulatorStep4_B.Gain_d = tmp_5 *
          windEmulatorStep4_B.BusAssignment_c.genSpeedActual;
        ...
        windEmulatorStep4_DW.INPUT_5_1_1_Discrete_4244925644[0] =
          !(windEmulatorStep4_B.INPUT_5_1_1[0] ==
            windEmulatorStep4_DW.INPUT_5_1_1_Discrete_4244925644[1]);
        windEmulatorStep4_DW.INPUT_5_1_1_Discrete_4244925644[1] =
          windEmulatorStep4_B.INPUT_5_1_1[0];
        windEmulatorStep4_B.INPUT_5_1_1[0] =
          windEmulatorStep4_DW.INPUT_5_1_1_Discrete_4244925644[1];
      ...
      /* SimscapeInputBlock: '<S229>/INPUT_3_1_1' */
      ...
      if (tmp_4) {
        /* SimscapeRtp: '<S196>/RTP_1' incorporates:
         *  Constant: '<S186>/Subsystem_around_RTP_D2E1D090_liquid_pressure'
         *  Constant: '<S186>/Subsystem_around_RTP_D2E1D090_liquid_volume'
        ...
        if (windEmulatorStep4_DW.RTP_1_SetParametersNeeded) {
          ...
          limitedCache = nesl_rtp_manager_set_rtps(rtpManager, Clock_tmp,
            expl_temp, diag);
          if (!limitedCache) {
            limitedCache = error_buffer_is_empty(rtmGetErrorStatus
              (windEmulatorStep4_M));
            if (limitedCache) {
        ...
        /* SimscapeExecutionBlock: '<S229>/STATE_1' incorporates:
         *  SimscapeExecutionBlock: '<S229>/OUTPUT_1_0'
         */
        ...
        tmp_1[1] = 4;
        tmp_0[4] = windEmulatorStep4_B.INPUT_2_1_1[0];
        tmp_0[5] = windEmulatorStep4_B.INPUT_2_1_1[1];
        tmp_0[6] = windEmulatorStep4_B.INPUT_2_1_1[2];
        tmp_0[7] = windEmulatorStep4_B.INPUT_2_1_1[3];
        tmp_1[2] = 8;
        tmp_0[8] = windEmulatorStep4_B.INPUT_4_1_1[0];
        tmp_0[9] = windEmulatorStep4_B.INPUT_4_1_1[1];
        tmp_0[10] = windEmulatorStep4_B.INPUT_4_1_1[2];
        tmp_0[11] = windEmulatorStep4_B.INPUT_4_1_1[3];
        tmp_1[3] = 12;
        tmp_0[12] = windEmulatorStep4_B.INPUT_5_1_1[0];
        tmp_0[13] = windEmulatorStep4_B.INPUT_5_1_1[1];
        tmp_0[14] = windEmulatorStep4_B.INPUT_5_1_1[2];
        tmp_0[15] = windEmulatorStep4_B.INPUT_5_1_1[3];
        tmp_1[4] = 16;
        ...
        rateLimiterRate = windEmulatorStep4_M->Timing.t[1];
        ...
        diagTree = neu_diagnostic_manager_get_initial_tree(diag);
        iy = ne_simulator_method(simulator, NESL_SIM_OUTPUTS, simulationData,
          diag);
        if (iy != 0) {
          limitedCache = error_buffer_is_empty(rtmGetErrorStatus
            (windEmulatorStep4_M));
        ...
        tmp_3[1] = 4;
        tmp_2[4] = windEmulatorStep4_B.INPUT_2_1_1[0];
        tmp_2[5] = windEmulatorStep4_B.INPUT_2_1_1[1];
        tmp_2[6] = windEmulatorStep4_B.INPUT_2_1_1[2];
        tmp_2[7] = windEmulatorStep4_B.INPUT_2_1_1[3];
        tmp_3[2] = 8;
        tmp_2[8] = windEmulatorStep4_B.INPUT_4_1_1[0];
        tmp_2[9] = windEmulatorStep4_B.INPUT_4_1_1[1];
        tmp_2[10] = windEmulatorStep4_B.INPUT_4_1_1[2];
        tmp_2[11] = windEmulatorStep4_B.INPUT_4_1_1[3];
        tmp_3[3] = 12;
        tmp_2[12] = windEmulatorStep4_B.INPUT_5_1_1[0];
        tmp_2[13] = windEmulatorStep4_B.INPUT_5_1_1[1];
        tmp_2[14] = windEmulatorStep4_B.INPUT_5_1_1[2];
        tmp_2[15] = windEmulatorStep4_B.INPUT_5_1_1[3];
        tmp_3[4] = 16;
        ...
        tmp_3[5] = 20;
        std::memcpy(&tmp_2[20], &windEmulatorStep4_B.STATE_1[0], 37U * sizeof
                    (real_T));
        tmp_3[6] = 57;
         ...
         */
        u1 = *get_A() * 2.0 * 3.1415926535897931 / *get_T() / *get_targetOmega();

        /* Product: '<S55>/Product2' */
        windEmulatorStep4_B.Product2 = windEmulatorStep4_B.ForceD * u1;
        ...
        /* RateLimiter: '<S124>/Rate Limiter1' incorporates:
         *  Constant: '<S124>/shaftSpeedRefMin'
         */
        ...
        if (rateLimiterRate > windEmulatorStep4_cal->RateLimiter1_RisingLim_o *
            windEmulatorStep4_period) {
          /* RateLimiter: '<S124>/Rate Limiter1' */
        ...
        /* End of RateLimiter: '<S124>/Rate Limiter1' */
      ...
      windEmulatorStep4_B.ControlSignal31_d = u1 * windEmulatorStep4_B.Add_m;
       ...
       */
      limitedCache = windEmulatorStep4_B.RelationalOperator_e;
      q0 = limitedCache;
      limitedCache = windEmulatorStep4_cal->Constant_Value_c;
      q0 = (q0 << 1) + limitedCache;
      limitedCache = windEmulatorStep4_B.Memory_o;
      q0 = (q0 << 1) + limitedCache;
      windEmulatorStep4_B.Logic_c[0U] = windEmulatorStep4_cal->Logic_table_h[q0];
      windEmulatorStep4_B.Logic_c[1U] = windEmulatorStep4_cal->Logic_table_h[q0
        + 8U];
      ...
      windEmulatorStep4_B.ControlSignal31_m = u1 * windEmulatorStep4_B.Add1_f;
      ...
      /* CombinatorialLogic: '<S185>/Logic' incorporates:
       *  Constant: '<S183>/Constant'
       */
      limitedCache = windEmulatorStep4_B.RelationalOperator_g;
      q0 = limitedCache;
      limitedCache = windEmulatorStep4_cal->Constant_Value_ks;
      q0 = (q0 << 1) + limitedCache;
      limitedCache = windEmulatorStep4_B.Memory_a;
      q0 = (q0 << 1) + limitedCache;
      windEmulatorStep4_B.Logic_p[0U] = windEmulatorStep4_cal->Logic_table_n[q0];
      windEmulatorStep4_B.Logic_p[1U] = windEmulatorStep4_cal->Logic_table_n[q0
        + 8U];
      ...
      if (windEmulatorStep4_B.Add_m > windEmulatorStep4_cal->Switch_Threshold_k)
      {
        ...
        if (windEmulatorStep4_B.Logic_c[0]) {
          ...
          rateLimiterRate = windEmulatorStep4_B.ControlSignal31_d;
          u1 = windEmulatorStep4_cal->Saturation_LowerSat_f;
          u2 = windEmulatorStep4_cal->Saturation_UpperSat_f;
          if (rateLimiterRate > u2) {
            /* Saturate: '<S182>/Saturation' */
            windEmulatorStep4_B.Saturation_af = u2;
          } else if (rateLimiterRate < u1) {
            /* Saturate: '<S182>/Saturation' */
        ...
        if (windEmulatorStep4_B.Add1_f >
          ...
          if (windEmulatorStep4_B.Logic_p[0]) {
             ...
             *  Switch: '<S183>/Switch'
             */
            rateLimiterRate = windEmulatorStep4_B.ControlSignal31_m;
            u1 = windEmulatorStep4_cal->Saturation_LowerSat_h;
            u2 = windEmulatorStep4_cal->Saturation_UpperSat_m;
            if (rateLimiterRate > u2) {
              /* Saturate: '<S183>/Saturation' */
              windEmulatorStep4_B.Saturation_p = u2;
            } else if (rateLimiterRate < u1) {
              /* Saturate: '<S183>/Saturation' */
      ...
      /* Gain: '<S127>/Gain' */
      windEmulatorStep4_B.Gain_f = tmp_9 * windEmulatorStep4_B.Switch_n;

      /* RateLimiter: '<S124>/Rate Limiter' */
      if (windEmulatorStep4_DW.LastMajorTime_k == (rtInf)) {
        /* RateLimiter: '<S124>/Rate Limiter' */
        windEmulatorStep4_B.RateLimiter_aw = windEmulatorStep4_B.Gain_f;
      } else {
        Clock_tmp = deltaT_tmp - windEmulatorStep4_DW.LastMajorTime_k;
        if (windEmulatorStep4_DW.LastMajorTime_k == deltaT_tmp) {
          if (windEmulatorStep4_DW.PrevLimited_dz) {
            /* RateLimiter: '<S124>/Rate Limiter' */
          ...
          if (f) {
            windEmulatorStep4_DW.PrevLimited_dz = limitedCache;
          }
        }
      }
      ...
      if (tmp_4) {
        ...
        windEmulatorStep4_B.ProportionalGain_h = tmp_g->PG *
          windEmulatorStep4_B.wError_c;
         ...
         */
        windEmulatorStep4_B.LowerRelop1_h = (windEmulatorStep4_B.Sum_n > tmp_a);

        /* RelationalOperator: '<S171>/UpperRelop' incorporates:
         *  Constant: '<S126>/Constant1'
         */
        u1 = -tmp_a;

        /* RelationalOperator: '<S171>/UpperRelop' */
        windEmulatorStep4_B.UpperRelop_m = (windEmulatorStep4_B.Sum_n < u1);
        ...
        if (windEmulatorStep4_B.UpperRelop_m) {
           ...
           *  Constant: '<S126>/Constant1'
           */
          windEmulatorStep4_B.Switch_c = -tmp_a;
        } else {
          /* Switch: '<S171>/Switch' */
        ...
        if (windEmulatorStep4_B.LowerRelop1_h) {
           ...
           *  Constant: '<S126>/Constant'
           */
          windEmulatorStep4_B.Switch2_m = tmp_a;
        } else {
          /* Switch: '<S171>/Switch2' */
       ...
       *  Switch: '<S124>/Switch'
       */
      if (windEmulatorStep4_B.Abs >= tmp_e) {
      ...
      if (tmp_4) {
        ...
        /* Gain: '<S199>/Gain' */
        windEmulatorStep4_B.ShaftSpeedPump = tmp_b *
      ...
      if (tmp_4) {
        ...
        /* Gain: '<S125>/Gain1' */
        windEmulatorStep4_B.Gain1_b = tmp_h->IG *
          windEmulatorStep4_B.DiscreteTimeIntegrator;
      }
      ...
      if (windEmulatorStep4_B.Abs >= tmp_e) {
         ...
         *  Constant: '<S125>/UnitsConversion'
         */
        u1 = 6.283185307179586E+6 / (tmp_k * 6894.75);

        /* Product: '<S125>/Product' */
        windEmulatorStep4_B.Product_aq = windEmulatorStep4_B.Divide * u1;

        /* Gain: '<S125>/Gain' */
        windEmulatorStep4_B.Gain_a = tmp_h->PG * windEmulatorStep4_B.Sum_f;
        ...
        rateLimiterRate = windEmulatorStep4_B.Add1_l;
        u1 = windEmulatorStep4_cal->Saturation_LowerSat_b;
        u2 = windEmulatorStep4_cal->Saturation_UpperSat_mj;
        if (rateLimiterRate > u2) {
          /* Saturate: '<S125>/Saturation' */
          windEmulatorStep4_B.Saturation_j = u2;
        } else if (rateLimiterRate < u1) {
          /* Saturate: '<S125>/Saturation' */
      ...
      /* Switch: '<S53>/Switch2' */
      if (windEmulatorStep4_B.Abs2 >= tmp_e) {
        /* Gain: '<S53>/Gain' */
        u1 = 1.0 / (tmp_k * 1.0E-6 * 0.15915494309189535) / 6894.75;

        /* Gain: '<S53>/Gain' */
        windEmulatorStep4_B.Gain_k = u1 * windEmulatorStep4_B.TorqueInputRef;
      ...
      if (tmp_4) {
        ...
        /* Gain: '<S60>/Gain1' */
        windEmulatorStep4_B.Gain1_j = tmp_i->IG *
          windEmulatorStep4_B.DiscreteTimeIntegrator_i;
        ...
        /* Gain: '<S123>/Gain1' */
        windEmulatorStep4_B.Gain1_h = tmp_i->IG *
          windEmulatorStep4_B.DiscreteTimeIntegrator_e;
      }
      ...
      if (windEmulatorStep4_B.Abs >= tmp_e) {
        /* Gain: '<S60>/Gain' */
        windEmulatorStep4_B.Gain_ge = tmp_i->PG * windEmulatorStep4_B.Sum_me;
        ...
        rateLimiterRate = windEmulatorStep4_B.Add_i;
        u1 = windEmulatorStep4_cal->Saturation_LowerSat_g;
        u2 = windEmulatorStep4_cal->Saturation_UpperSat_d;
        if (rateLimiterRate > u2) {
          /* Saturate: '<S60>/Saturation' */
          windEmulatorStep4_B.Saturation_a = u2;
        } else if (rateLimiterRate < u1) {
          /* Saturate: '<S60>/Saturation' */
        ...
        /* Gain: '<S123>/Gain' */
        windEmulatorStep4_B.Gain_j = tmp_i->PG * windEmulatorStep4_B.Sum_d;
        ...
        rateLimiterRate = windEmulatorStep4_B.Add_k;
        u1 = windEmulatorStep4_cal->Saturation_LowerSat_e;
        u2 = windEmulatorStep4_cal->Saturation_UpperSat_p;
        if (rateLimiterRate > u2) {
          /* Saturate: '<S123>/Saturation' */
          windEmulatorStep4_B.Saturation_f = u2;
        } else if (rateLimiterRate < u1) {
          /* Saturate: '<S123>/Saturation' */
      ...
      /* RateLimiter: '<S2>/acs880RateLim' */
      if (windEmulatorStep4_DW.LastMajorTime_a == (rtInf)) {
        /* RateLimiter: '<S2>/acs880RateLim' */
        windEmulatorStep4_B.acs880RateLim =
          windEmulatorStep4_B.MultiportSwitch_p;
      } else {
        Clock_tmp = deltaT_tmp - windEmulatorStep4_DW.LastMajorTime_a;
        if (windEmulatorStep4_DW.LastMajorTime_a == deltaT_tmp) {
          if (windEmulatorStep4_DW.PrevLimited_o) {
            /* RateLimiter: '<S2>/acs880RateLim' */
          ...
          u1 = Clock_tmp * *get_acs880RateLimRising();
          ...
          if (rateLimiterRate > u1) {
            ...
            Clock_tmp *= *get_acs880RateLimFalling();
            if (rateLimiterRate < Clock_tmp) {
              /* RateLimiter: '<S2>/acs880RateLim' */
              windEmulatorStep4_B.acs880RateLim = windEmulatorStep4_DW.PrevY_b +
                Clock_tmp;
          ...
          if (f) {
            windEmulatorStep4_DW.PrevLimited_o = limitedCache;
          }
        }
      }

      /* Saturate: '<S2>/Saturation' */
      rateLimiterRate = windEmulatorStep4_B.acs880RateLim;
      u1 = *get_acs880SetpointLimLower();
      u2 = *get_acs880SetpointLimUpper();
      if (rateLimiterRate > u2) {
        /* Saturate: '<S2>/Saturation' */
        windEmulatorStep4_B.ACS880Setpoint = u2;
      } else if (rateLimiterRate < u1) {
        /* Saturate: '<S2>/Saturation' */
      ...
      /* Gain: '<S2>/Nm -> %' */
      windEmulatorStep4_B.Nm = u1 * windEmulatorStep4_B.ACS880Setpoint;
      ...
      windEmulatorStep4_parseCtrlWord
        (windEmulatorStep4_B.BusAssignment_k.ctrlWord,
         ...
         &windEmulatorStep4_DW.sf_parseCtrlWord_h);
      ...
      /* Bias: '<S26>/ctrlWord' */
      windEmulatorStep4_B.ctrlWord = static_cast<uint16_T>
        (windEmulatorStep4_B.BusAssignment_k.ctrlWord +
      ...
      if (tmp_4) {
        ...
        /* Gain: '<S43>/rpm -> rad//s' */
        windEmulatorStep4_B.rpmrads_o = tmp_5 *
          windEmulatorStep4_B.BusAssignment_h.motorSpeed_rpm;
        ...
        windEmulatorSte_ParseStatusWord
          (windEmulatorStep4_B.BusAssignment_h.statusWord,
           ...
           &windEmulatorStep4_DW.sf_ParseStatusWord);
        ...
        windEmulatorStep4_B.ACS800CtrlMode = tmp_6;

        /* Chart: '<S16>/ABB Fieldbus Control' */
        if (windEmulatorStep4_DW.temporalCounter_i1_g < 31) {
          windEmulatorStep4_DW.temporalCounter_i1_g = static_cast<uint8_T>
            (windEmulatorStep4_DW.temporalCounter_i1_g + 1);
        }

        windEmulatorStep4_DW.sfEvent_d = windEmulatorStep4_CALL_EVENT_k;
        if (windEmulatorStep4_DW.is_active_c9_windEmulatorStep4 == 0) {
          windEmulatorStep4_DW.is_active_c9_windEmulatorStep4 = 1U;
          windEmulatorStep4_DW.is_active_UpdateStateMachine_a = 1U;
          windEmulatorStep4_DW.is_UpdateStateMachine_g =
            windEmulatorStep4_IN_initialize;
          windEmulatorStep4_cwInitialize();
          windEmulatorStep4_B.state_ed = abbStateEnum_init;
          windEmulatorStep4_DW.is_active_UpdateControlWord_p = 1U;
        } else {
          windEmulatorS_swParseStatusWord();
          windEmulatorStep4_DW.cwRESET_e = windEmulatorStep4_B.CastToDouble_j;
          switch (windEmulatorStep4_DW.is_UpdateStateMachine_g) {
           case windEmulatorStep4_IN_DelayOFF1:
            if (windEmulatorStep4_DW.temporalCounter_i1_g >= 25) {
              windEmulatorStep4_DW.is_UpdateStateMachine_g =
                windEmula_IN_notReadyToSwitchOn;
              windEmulatorStep4_DW.cwOFF1_CONTROL_i = 0.0;
            } else {
              windEmulatorStep4_B.state_ed = abbStateEnum_delayOff1;
            }
            break;
           ...
           case windEmula_IN_notReadyToSwitchOn:
            f = ((windEmulatorStep4_DW.swRDY_ON_f == 1.0) &&
                 (windEmulatorStep4_DW.swWARNING_k == 0.0));
            if (f) {
              windEmulatorStep4_DW.is_UpdateStateMachine_g =
                windEmulator_IN_readyToSwitchOn;
              ...
              windEmulatorStep4_B.state_ed = abbStateEnum_notReadyToSwitchOn;
            }
            break;

           case windEmulat_IN_operationDisabled:
            f = (windEmulatorStep4_B.NotEqual_f &&
                 (windEmulatorStep4_DW.swRDY_RUN_f == 1.0));
            if (f) {
              windEmulatorStep4_DW.is_UpdateStateMachine_g =
                windEmulato_IN_operationEnabled;
              windEmulatorStep4_DW.cwOFF1_CONTROL_i = 1.0;
              windEmulatorStep4_DW.cwENABLE_OPERATION_l = 1.0;
            } else {
              f = (windEmulatorStep4_B.NotEqual1_m ||
                   windEmulatorStep4_B.NotEqual_i ||
                   (windEmulatorStep4_DW.swTRIPPED_e == 1.0) ||
                   (windEmulatorStep4_DW.swSWC_ON_INHIB_l == 1.0) ||
                   (windEmulatorStep4_DW.swWARNING_k == 1.0));
              if (f) {
                windEmulatorStep4_DW.temporalCounter_i1_g = 0U;
                windEmulatorStep4_DW.is_UpdateStateMachine_g =
                  windEmulatorStep4_IN_DelayOFF1;
              } else {
                windEmulatorStep4_B.state_ed = abbStateEnum_operationDisabled;
              }
            }
            break;
           ...
           case windEmulato_IN_operationEnabled:
            if (windEmulatorStep4_B.NotEqual1_m) {
              ...
              if (f) {
                ...
                windEmulatorStep4_B.state_ed = abbStateEnum_operationEnabled;
              }
            }
            break;
           ...
           default:
            ...
            if (f) {
              ...
              windEmulatorStep4_B.state_ed = abbStateEnum_readyToSwitchOn;
            }
            break;
          }
        ...
        windEmulatorStep4_B.CastToDouble1_ia = windEmulatorStep4_B.state_ed;
      }
      ...
      /* Gain: '<S1>/Nm -> %' */
      windEmulatorStep4_B.Nm_j = u1 * windEmulatorStep4_B.MultiportSwitch1_m;

      /* BusAssignment: '<S1>/Bus Assignment' */
      windEmulatorStep4_B.BusAssignment_kc.ctrlWord =
        windEmulatorStep4_B.ControlWord_l;
      ...
      windEmulatorStep4_parseCtrlWord
        (windEmulatorStep4_B.BusAssignment_kc.ctrlWord,
         ...
         &windEmulatorStep4_DW.sf_parseCtrlWord);
      ...
      windEmulatorSte_MovingAverage_p(windEmulatorStep4_B.Product_gm,
        &windEmulatorStep4_B.MovingAverage_pn,
        &windEmulatorStep4_DW.MovingAverage_pn);

      /* Gain: '<S51>/rpm -> rad//s' */
      windEmulatorStep4_B.rpmrads_oh = tmp_5 *
        windEmulatorStep4_B.BusAssignment_n.excShaftSpeed_rpm;

      /* Product: '<S51>/Product1' */
      windEmulatorStep4_B.Product1_i = windEmulatorStep4_B.rpmrads_oh *
        windEmulatorStep4_B.BusAssignment_n.excShaftTorque_Nm;
      windEmulatorSte_MovingAverage_p(windEmulatorStep4_B.Product1_i,
      ...
      if (tmp_4) {
        ...
        /* Bias: '<S31>/expType' */
        windEmulatorStep4_B.expType = static_cast<uint16_T>
          (windEmulatorStep4_B.BusAssignment_b.expType +
        ...
        /* Abs: '<S240>/Abs' */
        iy = windEmulatorStep4_B.Add_d;
        if (iy < 0) {
          /* Abs: '<S240>/Abs' */
          windEmulatorStep4_B.Abs_a = -iy;
        } else {
          /* Abs: '<S240>/Abs' */
          windEmulatorStep4_B.Abs_a = iy;
        }
        ...
        if (windEmulatorStep4_B.RelationalOperator_l) {
          ...
          if (iy < 0) {
            ...
            /* Signum: '<S240>/Sign' */
            windEmulatorStep4_B.Sign = (iy > 0);
          }

          /* End of Signum: '<S240>/Sign' */
        ...
        /* Gain: '<S12>/rad//s->rpm' */
        windEmulatorStep4_B.radsrpm = tmp_b * windEmulatorStep4_B.Diff;
        ...
        /* DataTypeConversion: '<S243>/Cast To uint32' incorporates:
         *  Constant: '<S243>/sidType'
         */
      ...
      /* Gain: '<S297>/caseCounterSignalsNow' */
       ...
       *  Constant: '<S299>/Constant EngineeringValue'
       *  Constant: '<S299>/Constant FieldbusValue'
       */
      ...
      deltaT_tmp = std::floor(windEmulatorStep4_B.Product_k);
      if (rtIsNaN(deltaT_tmp) || rtIsInf(deltaT_tmp)) {
        deltaT_tmp = 0.0;
      } else {
        deltaT_tmp = std::fmod(deltaT_tmp, 65536.0);
      }

      /* DataTypeConversion: '<S14>/ACS800Ref2Int16' */
      windEmulatorStep4_B.ACS800Ref2Int16 = static_cast<int16_T>(deltaT_tmp <
        0.0 ? static_cast<int32_T>(static_cast<int16_T>(-static_cast<int16_T>(
        static_cast<uint16_T>(-deltaT_tmp)))) : static_cast<int32_T>(
        static_cast<int16_T>(static_cast<uint16_T>(deltaT_tmp))));
      if (tmp_4) {
         ...
         *  Constant: '<S298>/Constant EngineeringValue'
         *  Constant: '<S298>/Constant FieldbusValue'
         */
        ...
        deltaT_tmp = std::floor(windEmulatorStep4_B.Product_d);
        if (rtIsNaN(deltaT_tmp) || rtIsInf(deltaT_tmp)) {
          deltaT_tmp = 0.0;
        } else {
          deltaT_tmp = std::fmod(deltaT_tmp, 65536.0);
        ...
        /* DataTypeConversion: '<S14>/ACS800Ref1Int16' */
        windEmulatorStep4_B.ACS800Ref1Int16 = static_cast<int16_T>(deltaT_tmp <
          0.0 ? static_cast<int32_T>(static_cast<int16_T>(-static_cast<int16_T>(
          static_cast<uint16_T>(-deltaT_tmp)))) : static_cast<int32_T>(
          static_cast<int16_T>(static_cast<uint16_T>(deltaT_tmp))));
       ...
       *  Constant: '<S300>/Constant EngineeringValue'
       *  Constant: '<S300>/Constant FieldbusValue'
       */
      ...
      deltaT_tmp = std::floor(windEmulatorStep4_B.Product_l);
      if (rtIsNaN(deltaT_tmp) || rtIsInf(deltaT_tmp)) {
        deltaT_tmp = 0.0;
      } else {
        deltaT_tmp = std::fmod(deltaT_tmp, 65536.0);
      ...
      /* DataTypeConversion: '<S15>/ACS880Ref2Int16' */
      windEmulatorStep4_B.ACS880Ref2Int16 = static_cast<int16_T>(deltaT_tmp <
        0.0 ? static_cast<int32_T>(static_cast<int16_T>(-static_cast<int16_T>(
        static_cast<uint16_T>(-deltaT_tmp)))) : static_cast<int32_T>(
        static_cast<int16_T>(static_cast<uint16_T>(deltaT_tmp))));
      if (tmp_4) {
         ...
         */
        deltaT_tmp = std::floor(windEmulatorStep4_cal->Constant2_Value);
        if (rtIsNaN(deltaT_tmp) || rtIsInf(deltaT_tmp)) {
          deltaT_tmp = 0.0;
        } else {
          deltaT_tmp = std::fmod(deltaT_tmp, 65536.0);
        ...
        windEmulatorStep4_B.ACS880Ref1Int16 = static_cast<int16_T>(deltaT_tmp <
          0.0 ? static_cast<int32_T>(static_cast<int16_T>(-static_cast<int16_T>(
          static_cast<uint16_T>(-deltaT_tmp)))) : static_cast<int32_T>(
          static_cast<int16_T>(static_cast<uint16_T>(deltaT_tmp))));
        ...
        windEmulatorStep4_B.IntegralGain = tmp_g->IG *
          windEmulatorStep4_B.wError;

        /* Gain: '<S160>/Integral Gain' */
        windEmulatorStep4_B.IntegralGain_h = tmp_g->IG *
          windEmulatorStep4_B.wError_c;
      }
      ...
      if (tmp_4) {
        ...
        /* DataTypeConversion: '<S297>/vecIndex' */
        windEmulatorStep4_B.vecIndex = windEmulatorStep4_B.Mod;

        /* DataTypeConversion: '<S297>/Cast To Double' */
        windEmulatorStep4_B.CastToDouble_g = windEmulatorStep4_B.vecIndex;

        /* DataTypeConversion: '<S297>/Cast To Double1' incorporates:
         *  Constant: '<S297>/Length of input'
         */
        ...
        /* Bias: '<S297>/fileSamples' incorporates:
         *  Constant: '<S297>/Length of input'
         */
  ...
  if (rtmIsMajorTimeStep(windEmulatorStep4_M)) {
    ...
    int_T tmp_0[6];
    boolean_T tmp_2;
    tmp_2 = rtmIsMajorTimeStep(windEmulatorStep4_M);

    /* Update for RateLimiter: '<S297>/torqueSlewRate' incorporates:
     *  RateLimiter: '<S124>/Rate Limiter'
     *  RateLimiter: '<S297>/speedSlewRate'
     *  RateLimiter: '<S2>/acs880RateLim'
     *  RateLimiter: '<S61>/Rate Limiter'
    ...
    LastMajorTime_tmp = windEmulatorStep4_M->Timing.t[0];
    windEmulatorStep4_DW.LastMajorTime = LastMajorTime_tmp;

    /* Update for RateLimiter: '<S297>/speedSlewRate' */
    windEmulatorStep4_DW.PrevY_a = windEmulatorStep4_B.speedSlewRate;
    windEmulatorStep4_DW.LastMajorTime_j = LastMajorTime_tmp;

    /* Update for RateLimiter: '<S61>/Rate Limiter' */
    windEmulatorStep4_DW.PrevY_l = windEmulatorStep4_B.RateLimiter_b;
    windEmulatorStep4_DW.LastMajorTime_d = LastMajorTime_tmp;
    if (tmp_2) {
      ...
      /* Update for SimscapeExecutionBlock: '<S229>/STATE_1' */
      simulationData = static_cast<NeslSimulationData *>
        (windEmulatorStep4_DW.STATE_1_SimData);
      ...
      simulationData->mData->mIsModeUpdateTimeStep = true;
      tmp_0[0] = 0;
      tmp[0] = windEmulatorStep4_B.INPUT_1_1_1[0];
      tmp[1] = windEmulatorStep4_B.INPUT_1_1_1[1];
      tmp[2] = windEmulatorStep4_B.INPUT_1_1_1[2];
      tmp[3] = windEmulatorStep4_B.INPUT_1_1_1[3];
      tmp_0[1] = 4;
      tmp[4] = windEmulatorStep4_B.INPUT_2_1_1[0];
      tmp[5] = windEmulatorStep4_B.INPUT_2_1_1[1];
      tmp[6] = windEmulatorStep4_B.INPUT_2_1_1[2];
      tmp[7] = windEmulatorStep4_B.INPUT_2_1_1[3];
      tmp_0[2] = 8;
      tmp[8] = windEmulatorStep4_B.INPUT_4_1_1[0];
      tmp[9] = windEmulatorStep4_B.INPUT_4_1_1[1];
      tmp[10] = windEmulatorStep4_B.INPUT_4_1_1[2];
      tmp[11] = windEmulatorStep4_B.INPUT_4_1_1[3];
      tmp_0[3] = 12;
      tmp[12] = windEmulatorStep4_B.INPUT_5_1_1[0];
      tmp[13] = windEmulatorStep4_B.INPUT_5_1_1[1];
      tmp[14] = windEmulatorStep4_B.INPUT_5_1_1[2];
      tmp[15] = windEmulatorStep4_B.INPUT_5_1_1[3];
      tmp_0[4] = 16;
      tmp[16] = windEmulatorStep4_B.INPUT_3_1_1[0];
      tmp[17] = windEmulatorStep4_B.INPUT_3_1_1[1];
      tmp[18] = windEmulatorStep4_B.INPUT_3_1_1[2];
      tmp[19] = windEmulatorStep4_B.INPUT_3_1_1[3];
      tmp_0[5] = 20;
      simulationData->mData->mInputValues.mN = 20;
      ...
      tmp_1 = ne_simulator_method(simulator, NESL_SIM_UPDATE, simulationData,
        diagnosticManager);
      if (tmp_1 != 0) {
        tmp_2 = error_buffer_is_empty(rtmGetErrorStatus(windEmulatorStep4_M));
        if (tmp_2) {
      ...
      /* End of Update for SimscapeExecutionBlock: '<S229>/STATE_1' */
      ...
      /* Update for Memory: '<S240>/lastRawCounts' */
      windEmulatorStep4_DW.lastRawCounts_PreviousInput =
        windEmulatorStep4_B.CastToDouble_p;

      /* Update for Memory: '<S240>/lastTurn' */
...
void windEmulatorStep4_derivatives(void)
{
  ...
  /* Derivatives for Integrator: '<S278>/Integrator' */
  ...
  /* End of Derivatives for Integrator: '<S278>/Integrator' */

  /* Derivatives for StateSpace: '<S219>/Internal' */
  _rtXdot->Internal_CSTATE[0] = 0.0;
  _rtXdot->Internal_CSTATE[1] = 0.0;
  _rtXdot->Internal_CSTATE[2] = 0.0;
  for (ri = windEmulatorStep4_cal->Internal_A_jc[0U]; ri <
  ...
  for (ri = windEmulatorStep4_cal->Internal_A_jc[1U]; ri <
  ...
  for (ri = windEmulatorStep4_cal->Internal_A_jc[2U]; ri <
  ...
  for (ri = windEmulatorStep4_cal->Internal_B_jc[0U]; ri <
...
void windEmulatorStep4_initialize(void)
{
...

  {
    ...
    rtsiSetContStateDisabledPtr(&windEmulatorStep4_M->solverInfo, (boolean_T**)
      &windEmulatorStep4_M->contStateDisabled);
  ...
  rtsiSetIsContModeFrozen(&windEmulatorStep4_M->solverInfo, false);
  ...
  windEmulatorStep4_M->contStates = ((X_windEmulatorStep4_T *)
    &windEmulatorStep4_X);
  windEmulatorStep4_M->contStateDisabled = ((XDis_windEmulatorStep4_T *)
    &windEmulatorStep4_XDis);
  windEmulatorStep4_M->Timing.tStart = (0.0);
  ...
  {
    windEmulatorStep4_B.state_e = abbStateEnum_undefined;
    windEmulatorStep4_B.state_ed = abbStateEnum_undefined;
  ...
  /* disabled states */
  {
    (void) std::memset(static_cast<void *>(&windEmulatorStep4_XDis), 0,
                       sizeof(XDis_windEmulatorStep4_T));
  }
...

  {
    ...
    /* Start for SimscapeRtp: '<S196>/RTP_1' */
    ...
    /* End of Start for SimscapeRtp: '<S196>/RTP_1' */

    /* Start for SimscapeExecutionBlock: '<S229>/STATE_1' */
    ...
    modelParameters.mRTWModifiedTimeStamp = 7.04315587E+8;
    ...
    /* End of Start for SimscapeExecutionBlock: '<S229>/STATE_1' */

    /* Start for SimscapeExecutionBlock: '<S229>/OUTPUT_1_0' */
    simulator = nesl_lease_simulator(
    ...
    modelParameters_0.mRTWModifiedTimeStamp = 7.04315587E+8;
    ...
    /* End of Start for SimscapeExecutionBlock: '<S229>/OUTPUT_1_0' */
...

  {
    ...
    /* InitializeConditions for RateLimiter: '<S297>/torqueSlewRate' */
    windEmulatorStep4_DW.LastMajorTime = (rtInf);

    /* InitializeConditions for RateLimiter: '<S297>/speedSlewRate' */
    windEmulatorStep4_DW.LastMajorTime_j = (rtInf);

    /* InitializeConditions for Integrator: '<S278>/Integrator' */
    windEmulatorStep4_X.Integrator_CSTATE =
      windEmulatorStep4_cal->PIDController_InitialConditio_o;
    ...
    /* InitializeConditions for RateLimiter: '<S186>/Rate Limiter' */
    windEmulatorStep4_DW.PrevY_k = windEmulatorStep4_cal->RateLimiter_IC_g;

    /* InitializeConditions for StateSpace: '<S219>/Internal' */
    ...
    /* InitializeConditions for StateSpace: '<S233>/Internal' */
    windEmulatorStep4_X.Internal_CSTATE_j =
      windEmulatorStep4_cal->Internal_InitialCondition_p;

    /* InitializeConditions for StateSpace: '<S230>/Internal' */
    windEmulatorStep4_X.Internal_CSTATE_a =
    ...
    /* InitializeConditions for RateLimiter: '<S124>/Rate Limiter1' */
    ...
    /* InitializeConditions for RateLimiter: '<S124>/Rate Limiter' */
    windEmulatorStep4_DW.LastMajorTime_k = (rtInf);
    ...
    /* InitializeConditions for DiscreteIntegrator: '<S158>/Filter' */
    windEmulatorStep4_DW.Filter_DSTATE_b =
      windEmulatorStep4_cal->PIDController_InitialConditio_k;
    windEmulatorStep4_DW.Filter_PrevResetState_g = 0;
    ...
    windEmulatorStep4_DW.LastMajorTime_a = (rtInf);
    ...
    /* InitializeConditions for Memory: '<S240>/lastRawCounts' */
    windEmulatorStep4_DW.lastRawCounts_PreviousInput =
      windEmulatorStep4_cal->lastRawCounts_InitialCondition;

    /* InitializeConditions for Memory: '<S240>/lastTurn' */
    windEmulatorStep4_DW.lastTurn_PreviousInput =
    ...
    windEmulat_ParseStatusWord_Init(&windEmulatorStep4_DW.sf_ParseStatusWord_h);
    ...
    windEmulatorStep4_DW.is_UpdateStateMachine = is_UpdateStateMachine_tmp;
    ...
    windEmulatorStep4_DW.runTime = 0.0;
    windEmulatorStep4_B.runCounter_b = 0U;
    windEmulatorStep4_B.stepCounter_n = 0U;
    windEmulatorStep4_B.resetHilIntegrator_h = false;
    windEmulatorStep4_B.resetSidIntegrator_h = false;
    windEmulatorStep4_DW.is_active_c3_windEmulatorStep4 = 0U;
    windEmulatorStep4_DW.is_c3_windEmulatorStep4 = is_UpdateStateMachine_tmp;

    /* SystemInitialize for MATLAB Function: '<S46>/parseCtrlWord' */
    windEmulator_parseCtrlWord_Init(&windEmulatorStep4_DW.sf_parseCtrlWord_h);

    /* SystemInitialize for MATLAB Function: '<S44>/Parse Status Word' */
    windEmulat_ParseStatusWord_Init(&windEmulatorStep4_DW.sf_ParseStatusWord);
    ...
    windEmulatorStep4_DW.swAT_SETPOINT_b = 0.0;
    windEmulatorStep4_DW.swEXT_RUN_ENABLE_h = 0.0;
    windEmulatorStep4_DW.cwOFF2_CONTROL_b = 0.0;
    windEmulatorStep4_DW.cwOFF3_CONTROL_n = 0.0;
    windEmulatorStep4_DW.cwENABLE_OPERATION_l = 0.0;
    windEmulatorStep4_DW.cwRAMP_OUT_ZERO_m = 0.0;
    windEmulatorStep4_DW.cwRAMP_HOLD_j = 0.0;
    windEmulatorStep4_DW.cwRAMP_IN_ZERO_m = 0.0;
    windEmulatorStep4_DW.cwRESET_e = 0.0;
    windEmulatorStep4_DW.cwREMOTE_CMD_c = 0.0;
    windEmulatorStep4_DW.cwOFF1_CONTROL_i = 0.0;
    windEmulatorStep4_DW.swEXT_CTRL_LOC_c = 0.0;
    windEmulatorStep4_DW.swREMOTE_j = 0.0;
    windEmulatorStep4_B.ControlWord_l = 0U;
    ...
    windEmulatorStep4_DW.is_active_UpdateStateMachine_a = 0U;
    windEmulatorStep4_DW.is_UpdateStateMachine_g = is_UpdateStateMachine_tmp;
    windEmulatorStep4_DW.is_active_UpdateControlWord_p = 0U;

    /* SystemInitialize for MATLAB Function: '<S41>/parseCtrlWord' */
    windEmulator_parseCtrlWord_Init(&windEmulatorStep4_DW.sf_parseCtrlWord);
    ...
    windEmulat_MovingAverage_e_Init(&windEmulatorStep4_DW.MovingAverage_pn);
    windEmulat_MovingAverage_e_Init(&windEmulatorStep4_DW.MovingAverage1);
  }
}
...
void windEmulatorStep4_terminate(void)
{
  ...
  /* Terminate for SimscapeExecutionBlock: '<S229>/STATE_1' */
  diagnosticManager = static_cast<NeuDiagnosticManager *>
    (windEmulatorStep4_DW.STATE_1_DiagMgr);
  ...
  /* Terminate for SimscapeExecutionBlock: '<S229>/OUTPUT_1_0' */
  diagnosticManager = static_cast<NeuDiagnosticManager *>
    (windEmulatorStep4_DW.OUTPUT_1_0_DiagMgr);
  neu_destroy_diagnostic_manager(diagnosticManager);
  simulationData = static_cast<NeslSimulationData *>
  ...
  windEmulat_MovingAverage_g_Term(&windEmulatorStep4_DW.MovingAverage_pn);
  windEmulat_MovingAverage_g_Term(&windEmulatorStep4_DW.MovingAverage1);
