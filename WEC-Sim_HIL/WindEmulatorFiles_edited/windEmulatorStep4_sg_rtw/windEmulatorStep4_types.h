...
#ifndef windEmulatorStep4_types_h_
#define windEmulatorStep4_types_h_
#include "rtwtypes.h"
#include "expType.h"
#include "sidType.h"
#include "abbState.h"
...
#ifndef struct_cell_wrap_windEmulatorStep4_T
#define struct_cell_wrap_windEmulatorStep4_T

struct cell_wrap_windEmulatorStep4_T
{
  uint32_T f1[8];
};

#endif                                /* struct_cell_wrap_windEmulatorStep4_T */
...
struct dsp_simulink_MovingAverage_wi_T
{
  ...
  cell_wrap_windEmulatorStep4_T inputVarSize;
  int32_T NumChannels;
  int32_T FrameLength;
  real_T pCumSum;
...
typedef struct tag_RTM_windEmulatorStep4_T RT_MODEL_windEmulatorStep4_T;

#endif                                 /* windEmulatorStep4_types_h_ */
