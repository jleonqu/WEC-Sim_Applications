...
{
  return &RTE_Param_Service_ptr->genShaftSpeedRef;
}

real_T* get_iGainGen(void)
{
  return &RTE_Param_Service_ptr->iGainGen;
}
...
{
  return &RTE_Param_Service_ptr->m3persecond2lpm;
}
...
{
  return &RTE_Param_Service_ptr->pGainGen;
}

real_T* get_pa2psi(void)
{
  return &RTE_Param_Service_ptr->pa2psi;
}
...
{
  return &RTE_Param_Service_ptr->radsec2rpm;
}
...
namespace slrealtime
{
  ...
  SegmentVector segmentInfo {
    ...
    { (void*)&windEmulatorStep4_WECS_cal_impl, (void**)
      &windEmulatorStep4_WECSim_cal, sizeof(windEmulatorStep4_WECS_cal_type), 2
    }
  };
