...
simu.simMechanicsFile = 'windEmulatorStep4_WECSim.slx';    % Specify Simulink Model File
...
simu.dt = Ts;                          % Simulation Time-Step [s]
...
pto(1).damping = 12000*0;                         % PTO Damping Coeff [Nsm/rad]
